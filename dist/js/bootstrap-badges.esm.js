...
const NAME$1 = 'badge';
const DATA_KEY$1 = 'bs.badge';
const EVENT_KEY$1 = `.${DATA_KEY$1}`;
const EVENT_CLOSE = `close${EVENT_KEY$1}`;
const EVENT_CLOSED = `closed${EVENT_KEY$1}`;
/**
 * ------------------------------------------------------------------------
 * Class Definition
 * ------------------------------------------------------------------------
...
const COLOUR_VALUES = ['primary', 'secondary', 'success', 'danger', 'warning', 'info', 'light', 'dark'];
...
export { Badge, InputBadges };
//# sourceMappingURL=bootstrap-badges.esm.js.map
